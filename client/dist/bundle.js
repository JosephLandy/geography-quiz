...
var optionsListTemplate = __webpack_require__(6);
var basicTemplate = __webpack_require__(23);
// NOTE: URL must be in this format to avoid cross site scripting issues.
const TOPLEVELURL = "http://localhost:3000";
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {

  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#ajax-btn').click(() => {
    var url = TOPLEVELURL + '/questionData';

    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.getJSON(url).done(function (data) {
      console.log(JSON.stringify(data, 2));
      //injectTemplate("hbs-container", OptionsListTemplate, data);
      var htmlTemplated = optionsListTemplate(data);
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#hbs-container').html(htmlTemplated);
    });
  });
});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <li>\n    <span>\n      <input type=\"radio\" name=\"answer\" id="
    ...
    + "</strong>\n        <img src="
    + alias4(((helper = (helper = helpers.flaglink || (depth0 != null ? depth0.flaglink : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"flaglink","hash":{},"data":data}) : helper)))
    + " class=\"flag-thumbnail\" width=\"80px\">\n      </label>\n    </span>\n  </li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "<ul>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.responses : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</ul>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div>\n  <h1>"
    + alias4(((helper = (helper = helpers.element1 || (depth0 != null ? depth0.element1 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"element1","hash":{},"data":data}) : helper)))
    + "</h1>\n  <p>"
    + alias4(((helper = (helper = helpers.element2 || (depth0 != null ? depth0.element2 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"element2","hash":{},"data":data}) : helper)))
    + "</p>\n</div>\n";
},"useData":true});
